...
//         dnsRecords, // Assuming dnsRecords is a list of DnsRecord objects
...
//     const batchSize =
//         5; // Increased batch size for better concurrency, adjust based on device limits
...
//     // Don't lock the dialog for sequential test
//     setCancelTest?.call(false);
...
//       dnsRecords.sort((a, b) {
//         final minA = [
//           pingCache['${a.id}_1'] ?? 9999,
//           pingCache['${a.id}_2'] ?? 9999
//         ].reduce((x, y) => x < y ? x : y);
//         final minB = [
//           pingCache['${b.id}_1'] ?? 9999,
//           pingCache['${b.id}_2'] ?? 9999
//         ].reduce((x, y) => x < y ? x : y);
...
//     return pingCache; // Return the final ping cache map
//   }
...
//         debugPrint('Testing ${record.label} - Round ${round + 1}');
...
//         debugPrint(
//             '${record.label} - Round ${round + 1} completed in ${duration.inMilliseconds}ms');
...
//             pingCache['${record.id}_1'] =
//                 (data['pings1'].reduce((a, b) => a + b) / data['pings1'].length)
//                     .round();
//           }
//           if (data['pings2'].isNotEmpty) {
//             pingCache['${record.id}_2'] =
//                 (data['pings2'].reduce((a, b) => a + b) / data['pings2'].length)
//                     .round();
//           }
