            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDark ? AppColors.darkBackground : AppColors.backgroundGrey.withOpacity(0.3),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        color: !notification.isRead
            ? (isDark ? AppColors.darkBackground.withOpacity(0.3) : AppColors.backgroundGrey.withOpacity(0.2))
            : Colors.transparent,
        child: Row(
